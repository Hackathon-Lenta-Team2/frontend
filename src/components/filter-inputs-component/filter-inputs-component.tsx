...
export default function FilterInputsComponent({ isSubmitClicked }: { isSubmitClicked: boolean }): ReactElement {
  ...
  const selectedCategories = useSelector((store) => store.filter.selectedCategories);
  const selectedSubcategories = useSelector((store) => store.filter.selectedSubcategories);
  const selectedProducts = useSelector((store) => store.filter.selectedProducts);
